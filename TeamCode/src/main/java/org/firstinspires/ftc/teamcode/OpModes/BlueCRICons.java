...
@Autonomous(name = "Blue CRI Consolidated", group = "Competition")
public class BlueCRICons extends OpMode {
    ...
    TrajectorySequence cycle_trajectory;
    TrajectorySequence park_trajectory1;
    TrajectorySequence park_trajectory2;
    TrajectorySequence park_trajectory3;
    ...
    public void init() {
        ...
        cycle_trajectory = drive.trajectorySequenceBuilder(startPose)
        ...
        park_trajectory1 = drive.trajectorySequenceBuilder(startPose)
                // park
                .lineToSplineHeading(new Pose2d(-10,-12,Math.toRadians(90)))
                .lineToSplineHeading(new Pose2d(-10,-28,Math.toRadians(90)))
                .UNSTABLE_addTemporalMarkerOffset(0,() -> {stop();})
                .build();

        park_trajectory2 = drive.trajectorySequenceBuilder(startPose)
                // park
        ...
        park_trajectory3 = drive.trajectorySequenceBuilder(startPose)
                // park
    ...
    public void start(){
        ...
        drive.followTrajectorySequenceAsync(cycle_trajectory);

        if (parkPosition == 1) {
            drive.followTrajectorySequenceAsync(park_trajectory1);
        } else if (parkPosition == 3) {
            drive.followTrajectorySequenceAsync(park_trajectory3);
        } else {
            drive.followTrajectorySequenceAsync(park_trajectory2);
        }
    }
