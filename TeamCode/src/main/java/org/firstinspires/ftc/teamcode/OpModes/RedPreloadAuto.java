...
public class RedPreloadAuto extends OpMode {
    ...
    public void init() {
        ...
        trajectory1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToSplineHeading(new Pose2d(-36,-10,Math.toRadians(135)))

                .UNSTABLE_addTemporalMarkerOffset(-.75, () -> {
                    liftTarget = clawControl.moveLiftScore(2, true);
                })

                .UNSTABLE_addTemporalMarkerOffset(.25, () -> {
                    liftTarget = clawControl.moveLiftScore(2,-robot.liftTicksPerInch*4, true);
                })
