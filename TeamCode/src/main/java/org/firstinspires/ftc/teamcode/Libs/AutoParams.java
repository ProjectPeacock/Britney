...
public class AutoParams {
    ...
    public final int cycle1=(int)8.25*liftTicksPerInch;
    public final int cycle2=(int)6.50*liftTicksPerInch;
    public final int cycle3=(int)4.75*liftTicksPerInch;
    public final int cycle4=(int)2.75*liftTicksPerInch;
